...
class EditProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Biike.logger.d(_profileController.user.userFullname);
    Biike.logger.d(_profileController.user.gender);
    Biike.logger.d(_profileController.user.birthDate);

    return WillPopScope(
      onWillPop: () => CommonFunctions()
          .reloadProfile(profileController: _profileController),
      child: Scaffold(
                      ...
                      Obx(
                        () => ChooseDateTimeButton(
                            ...
                            onPressedFunc: () async {
                              ...
                              _birthDateText.value = DateFormat('dd-MM-yyyy')
