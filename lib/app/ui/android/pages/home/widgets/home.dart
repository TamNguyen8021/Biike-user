            ...
            child:
              ...
              if (homeController.upcomingTrips.isNotEmpty) ...[
                if (_firstTripTimeBook.day == _currentTime.day &&
                    _firstTripTimeBook.month == _currentTime.month &&
                    _firstTripTimeBook.year == _currentTime.year) ...[
                  Padding(
                  ...
                  Padding(
                    ...
                    child: UpcomingTripCard(
                        ...
                        tripId: homeController.upcomingTrips.toList()[0].tripId,
                        userId: homeController.upcomingTrips.toList()[0].userId,
                        backgroundColor: CustomColors.kBlue,
                        foregroundColor: Colors.white,
                        iconColor: Colors.white,
                        avatarUrl:
                            homeController.upcomingTrips.toList()[0].avatarUrl,
                        name: homeController.upcomingTrips.toList()[0].name,
                        phoneNo:
                            homeController.upcomingTrips.toList()[0].phoneNo,
                        bookTime:
                            homeController.upcomingTrips.toList()[0].bookTime,
                        departureStation: homeController.upcomingTrips
                            .toList()[0]
                            .departureStation,
                        destinationStation: homeController.upcomingTrips
                            .toList()[0]
                            .destinationStation),
                  ),
                  Row(
            ...
            if (Biike.role.value == Role.keer) ...[
                                              ...
                                              await CommonFunctions()
                                                  .selectTime(
                                                      ...
                                                      selectedTime:
                                                          homeController
                                                              .searchTime);
                                          int tempTimeNum = tempTime.hour * 60 +
                                              tempTime.minute;
                                          int lowestBoundTimeNum = 5 * 60;
                                          int highestBoundTimeNum = 21 * 60;
                                          if (tempTimeNum >=
                                                  lowestBoundTimeNum &&
                                              tempTimeNum <=
                                                  highestBoundTimeNum) {
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: CustomTextButton(
                              ...
                              onPressedFunc: () {
                                homeController.upcomingTripsForBiker.clear();
                                homeController.hasSearchedTrips = false;
                                homeController.searchDateString.value =
                                    CustomStrings.kChooseDate.tr;
                                homeController.searchTimeString.value =
                                    CustomStrings.kChooseTime.tr;
                                homeController
                                    .departureStation.value.stationId = -1;
                                homeController.departureStationName.value =
                                    homeController.departureStation.value.name =
              ...
              Padding(
                ...
                child: Obx(
                  () => ListUpcomingTrips(
                      listUpcomingTrips:
                          homeController.upcomingTripsForBiker.toList(),
                      itemPadding: 10.0,
                      hasSearchTrips: homeController.hasSearchedTrips),
                ),
              ),
            ]
          ] else ...[
