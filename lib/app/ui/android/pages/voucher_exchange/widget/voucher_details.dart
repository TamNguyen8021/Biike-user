            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  if (voucher.voucherAddresses != null &&
                      voucher.voucherAddresses!.length > 0) ...[
                    Container(
                      child: Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: <Widget>[
                          Padding(
                            padding: const EdgeInsets.symmetric(vertical: 5.0),
                            child: Text(
                              CustomStrings.kApplicablePlaces.tr,
                              style: Theme.of(context)
                                  .textTheme
                                  .bodyText2!
                                  .copyWith(
                          ...
                          for (var places in voucher.voucherAddresses!)
                            Padding(
                              padding:
                                  const EdgeInsets.symmetric(vertical: 5.0),
                              child: Text(
                                '+ ${places!.addressName.toString()}: ${places.addressDetail.toString()}',
                                style: Theme.of(context).textTheme.bodyText1,
                              ),
                            ),
                        ],
