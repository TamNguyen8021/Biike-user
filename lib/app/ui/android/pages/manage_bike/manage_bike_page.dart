...
class ManageBikePage extends StatelessWidget {
  const ManageBikePage({Key? key}) : super(key: key);
                        ...
                        child: IconButton(
                          onPressed: () {
                            CommonFunctions().showConfirmDialog(
                                ...
                                message: CustomStrings.kAreYouSureDeleteBike.tr,
                                onPressedFunc: () async {
                                  await manageBikeController.removeBike(
                                      context: context);
                                });
                          },
