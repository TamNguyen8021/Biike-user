...
import 'package:bikes_user/app/bindings/search_address_binding.dart';
...
import 'package:bikes_user/app/ui/android/pages/first_save_address/first_save_address_page.dart';
...
import 'package:bikes_user/app/ui/android/pages/search_address/search_address_page.dart';
...
class AppPages {
  static final pages = [
    ...
    GetPage(
        name: CommonRoutes.FIRST_SAVE_ADDRESS,
        page: () => FirstSaveAddressPage(),
    ),
    GetPage(
        name: CommonRoutes.SEARCH_ADDRESS,
