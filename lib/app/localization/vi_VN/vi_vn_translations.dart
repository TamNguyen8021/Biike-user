final Map<String, String> vi = {
  ...
  'kFirstDescription' : 'Biiké là nền tảng kết nối hoàn toàn miễn phí, bạn không cần phải trả bất kỳ chi phí gì khi sử dụng app',
  'kSecondDescription' : 'Biiké kết nối những người có chung hành trình, giúp tận dụng những chiếc yên xe vốn lãng phí',
  'kThirdDescription' : 'Biiké giúp giảm thiểu lượng xe lưu thông, giảm kẹt xe, khói bụi và bảo vệ môi trường',
  ...
  'kBikerDescription' : 'Lựa chọn người bạn muốn chở, bắt đầu hành trình, nhận điểm thưởng và đổi lấy những voucher giá trị',
  ...
  'kKeerReadyReminder' : 'kKeerReadyReminder',
  ...
  'kSorryMessage' : 'Biiké rất tiếc vì những trải nghiệm chưa được hoàn hảo. Biiké đã nhận được thông tin báo cáo và sẽ xử lý trong thời gian sớm nhất.',
  ...
  'kTips' : 'Bạn có thể tạo chuyến đi đặt lịch để tăng khả năng tìm được người chở ké nhé!',
  'kBtnExit' : 'Thoát',
  ...
  'kBuyReminder' : 'Vì đây là chuyến đi miễn phí, nên đừng quên gửi lời cảm ơn đến người bạn đồng hành, lâu lâu mua một ly cà phê hoặc một ổ bánh mì sẽ là ý tưởng xuất sắc đấy!',
  'kRateReminder' : 'Hãy đánh giá trải nghiệm của bạn cùng \'người ấy\' hôm nay nhé!',
  'kBtnSend' : 'Gửi',
